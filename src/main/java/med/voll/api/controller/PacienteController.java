...
public class PacienteController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroPaciente paciente, UriComponentsBuilder uriBuilder) {
        var dadosPaciente = new Paciente(paciente);
